...
//  EssentialFeedTests
//
//  Created by tamorim on 13/09/2022.
//
...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_insert_overridesPriviouslyInsertedCacheValue() {
        let sut = makeSUT()
    ...
    func test_delete_hasNoSideEffectsOnEmptyCache() {
        ...
        XCTAssertNil(deletionError, "Expected delete cache to succed")
    ...
    private func expect(_ sut: CodableFeedStore, toRetriveTwice expectedResult: RetriveCachedFeedResult, file: StaticString = #filePath, line: UInt = #line) {
        expect(sut, toRetrive: expectedResult, file: file, line: line)
        expect(sut, toRetrive: expectedResult, file: file, line: line)
    }
    
    private func expect(_ sut: CodableFeedStore, toRetrive expectedResult: RetriveCachedFeedResult, file: StaticString = #filePath, line: UInt = #line) {
        let exp = expectation(description: "Wait for cache retrieval")
